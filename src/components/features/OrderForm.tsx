              ...
              <div key={index} className="flex gap-3">
                <div className="flex-1">
                  <input
                    ...
                    className="w-full text-[16px] px-4 py-3 border-2 border-blue-200 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-400 transition-all bg-white"
        ...
        <div className="bg-white border-2 border-gray-200 rounded-2xl p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full text-[16px] px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-orange-100 focus:border-orange-400 transition-all"
                placeholder="山田太郎"
              />
              {errors.customerName && (
          ...
          <div className="mt-6">
            ...
            <textarea
              ...
              rows={4}
              className="w-full text-[16px] px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-orange-100 focus:border-orange-400 transition-all resize-vertical"

        ...
        <div className="c2">
          ...
          <div className="text">
            <dl className="faq">
              ...
              <dd>元動画の長さ（分数）に応じて料金が決まります。AIのみの場合は1分あたり100円、人の目で確認する高品質プランは1分あたり150円です。最低料金は1,000円で、5分以下の動画でも最低料金が適用されます。例：15分動画（AIのみ）= 1,500円、30分動画（人の目で確認）= 4,500円</dd>
              ...
              <dd>はい、動画に十分なコンテンツがない場合や、コンテンツがAIの分析に適さない場合、クリップが生成されない可能性があります。特に会話が少ない動画や音声が不明瞭な動画では、切り抜き動画が生成されない場合があります。</dd>
              ...
              <dd>より多くのクリップを作成するには、以下の方法をお試しください：1）アップロード前にクリップの長さとして「30秒未満」を選択する、2）より鮮明で多様なコンテンツを含む動画をご提供いただく。また、15分以上の長い動画の方がAIが適切なクリッピングポイントを見つけやすくなります。</dd>
            </dl>
          </div>
        </div>
      </section>
